...
const TEST_CASES = [
    ...
    {
        token: "120",
        line: "const HELLO = 120;",
        expected: "2m",
        desc: "Basic seconds",
    },
    {
        token: "300",
        line: "const TIMEOUT = 300;",
        expected: "5m",
        desc: "Timeout context",
    },
    {
        token: "5000",
        line: "const DELAY = 5000;",
        expected: "5s",
        desc: "Delay context",
    },
    {
        token: "30000",
        line: "const RETRY_INTERVAL = 30000;",
        expected: "30s",
        desc: "Retry interval",
    },
    {
        token: "3600",
        line: "const CACHE_TTL = 3600;",
        expected: "1h",
        desc: "Cache TTL",
    },
    {
        token: "86400",
        line: "const MAX_AGE = 86400;",
        expected: "1d",
        desc: "Max age",
    },
    ...
    {
        token: "5000",
        line: "const retryDelayMs = 5000;",
        expected: "5s",
        desc: "Ms suffix",
    },
    {
        token: "120",
        line: "const timeoutSeconds = 120;",
        expected: "2m",
        desc: "Seconds suffix",
    },
    {
        token: "48",
        line: "const cacheDurationHours = 48;",
        expected: "2d",
        desc: "Hours suffix",
    },
    {
        token: "30",
        line: "const sessionTTLMinutes = 30;",
        expected: "30m",
        desc: "Minutes suffix",
    },
    ...
    {
        token: "60 * 60",
        line: "const ONE_MINUTE_SECONDS = 60 * 60;",
        expected: "1h",
        desc: "Expression",
    },
    {
        token: "24 * 60 * 60",
        line: "const ONE_DAY_SECONDS = 24 * 60 * 60;",
        expected: "1d",
    ...
    {
        token: "24",
        line: "const VALUE_HOURS = 24;",
        expected: "1d",
        desc: "Hours unit",
    },
    {
        token: "7",
        line: "const VALUE_DAYS = 7;",
        expected: "1w",
        desc: "Days unit",
    },
    {
        token: "2",
        line: "const VALUE_WEEKS = 2;",
        expected: "2w",
        desc: "Weeks unit",
    },
    {
        token: "3",
        line: "const VALUE_MONTHS = 3;",
        expected: "3mo",
        desc: "Months unit",
    },
    {
    ...
    // Edge cases
    {
        ...
        line: "const ZERO = 0;",
        expected: null,
        desc: "Zero (should ignore)",
    },
    {
        token: "9999999999999",
        line: "const VERY_LARGE = 9999999999999;",
        expected: null,
        desc: "Very large (should ignore)",
    },
    {
        token: "0xFF",
        line: "const HEX = 0xFF;",
        expected: null,
        desc: "Hex (should ignore)",
    },
];
